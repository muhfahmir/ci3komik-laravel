...
<div class="card mb-3">
    <div class="card-body">
        <h1 class="h3 mb-0 text-gray-800 card-title">Add Comic</h1>
    </div>
</div>
...
<form action="{{ route('comic-store') }}" method="post"  enctype="multipart/form-data">
    ...
    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <div class="form-group" id="form-status">
                                ...
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="status_komik" name="status_komik" value="0">
                                    <label class="custom-control-label" for="status_komik" id="labelStatus">Tidak Active</label>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-12 d-flex justify-content-end m-3">
            <a class="btn btn-secondary" href="{{ route('user') }}">Kembali</a>
...
@push('scripts')
    <script>
        let status = document.querySelector('#status_komik')
